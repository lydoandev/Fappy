...
class NewRestaurants extends React.Component {
  ...
  uploadImage = () => {
    let { imageAsFile, restaurants } = this.state;
    ...
    (snapShot) => {
      ...
      storage.ref('images').child(imageAsFile.name).getDownloadURL()
       .then(fireBaseUrl => {
         ...
         this.setState(prevObject => ({...prevObject, restaurants}))
       })
  ...
  handleSave = () => {
    ...
    if (isValid) {
      ...
      alert("This Restaurants has data incorrect!");
    }
  };
  ...
  addRestaurants = (restaurants) => {
    ...
    ref.push(restaurants)
      ...
      .then(() => {
        ...
        alert("this restaurants add sucess");
      })
      .catch((error) => {
        alert("update restaurants incorrect");
      });
  };
                ...
                <CForm className="form-horizontal">
                  <CFormGroup row>
                    ...
                    <CCol xs="12" md="9">
                      ...
                      /><CFormText>Please enter your restaurant name</CFormText>
                    </CCol>
                  </CFormGroup>
